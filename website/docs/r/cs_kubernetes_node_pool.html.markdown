...
* `registry` - (Required, String) The registry address without protocol prefix (e.g., `docker.io`, `registry.example.com`, `192.168.1.1:5000`).
* `mirror` - (Required, String) The mirror URL with protocol prefix (e.g., `https://mirror.example.com`, `http://192.168.1.1:5000`).
